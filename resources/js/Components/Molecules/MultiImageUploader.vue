...
<script>
import Feedback from "@/Components/Atoms/FormFeedback.vue";
    ...
    methods: {
            ...
            try {
                ...
                for (let i = 0; i < imageUrls.length; i++) {
                    ...
                    try {
                        ...
                        // Create a placeholder file for the error state
        ...
        removeImage(index) {
            try {
                ...
                // Clear error message if there are no more images
        ...
        emitUpdate() {
            try {
                // Filter out error files for the emit
