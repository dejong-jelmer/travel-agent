...
<template>
    <div class="space-y-6">
        <!-- Prijs & Offerte -->
        <div class="bg-white rounded-lg border border-brand-accent/20 p-4 tablet:p-6">
        ...
        <div class="bg-white rounded-lg border border-brand-accent/20 p-4 tablet:p-6">
            <div class="flex items-start gap-3 mb-3">
                <div class="flex-shrink-0 mt-1">
                    <CreditCard class="w-5 h-5 text-brand-accent" />
                </div>
                <div class="flex-1 min-w-0">
                    <h4 class="text-base tablet:text-lg font-semibold text-brand-primary mb-2">
                        Betalingsvoorwaarden
        ...
        <div class="bg-white rounded-lg border border-brand-accent/20 p-4 tablet:p-6">
            <div class="flex items-start gap-3 mb-3">
                <div class="flex-shrink-0 mt-1">
                    <Wallet class="w-5 h-5 text-brand-accent" />
                </div>
                <div class="flex-1 min-w-0">
                    <h4 class="text-base tablet:text-lg font-semibold text-brand-primary mb-2">
                        Betaalmethoden
        ...
        <div class="bg-brand-subtle/10 rounded-lg border border-brand-subtle/30 p-4 tablet:p-6">
            <div class="flex items-start gap-3">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-sm tablet:text-base text-brand-text leading-relaxed mb-3">
