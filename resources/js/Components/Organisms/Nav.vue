...
<template>
    <nav class="max-w-screen-desktop mx-auto h-20 laptop:h-24 px-6 flex items-center justify-between">
        <!-- Logo -->
        <div class="min-w-[80px] laptop:w-[120px]">
            <Transition mode="out-in" enter-active-class="transition-opacity duration-300 ease-in-out"
                ...
                <div class="text-xl font-bold" :class="logoClass">
                    <Link :href="'/'">
                    <Logo
                        class="text-neutral-25 w-[150px] laptop:w-[192px] h-[48px] laptop:h-[62px] filter drop-shadow-md" />
                    </Link>
                </div>
            </Transition>
        </div>
        ...
        <!-- Mobile Menu -->
        <MobileMenu :is-scrolled="isScrolled" class="tablet:hidden">
