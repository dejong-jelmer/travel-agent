                ...
                <div class="laptop:col-span-3 bg-white py-10">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex space-x-2">
                            <IconLink icon="Pencil" :href="route('admin.products.edit', product)" v-tippy="'Bewerk reisproduct'" />
                    ...
                    <section class="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
                        ...
                        <div class="p-6 space-y-4">
                            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                                ...
                                <Pill
                                    :type="product.active ? 'success' : 'warning'"
                                >
                        ...
                        <div class="p-6">
                            <div class="flex flex-wrap gap-2">
                                <Pill
                                    ...
                                    :key="country.id" type="success" variant="transparent">
                                    {{ country.name }}
                                </Pill>
                            </div>
                        </div>
