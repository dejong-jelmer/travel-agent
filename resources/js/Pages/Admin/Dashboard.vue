        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-6 space-y-3">
                    ...
                    >
                        <div class="flex items-center">
                            <div class="bg-brand-accent/10 rounded-lg p-2 mr-3">
                                <CalendarDaysIcon class="h-5 w-5 text-brand-accent" />
                            </div>
                    ...
                    >
                        <div class="flex items-center">
                            <div class="bg-brand-subtle/10 rounded-lg p-2 mr-3">
                                <svg class="h-5 w-5 text-brand-subtle" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    >
                        <div class="flex items-center">
                            <div class="bg-brand-link/10 rounded-lg p-2 mr-3">
                                <svg class="h-5 w-5 text-brand-link" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <!-- System Info Card -->
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="bg-brand-subtle  px-6 py-4">
                    <h3 class="text-lg font-semibold text-white flex items-center">
