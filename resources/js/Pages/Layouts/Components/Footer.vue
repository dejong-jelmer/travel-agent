...
<template>
    <footer class="bg-contrast-blue">
        <div
            class="max-w-screen-desktop px-4 pt-16 pb-6 mx-auto tablet:px-6 laptop:px-8 laptop:pt-24"
        >
            <div class="grid grid-cols-1 gap-8 laptop:grid-cols-3">
                <div>
                    <div
                        class="flex justify-center text-light-green tablet:justify-start"
                    >
                        <Logo class="text-white w-[192] h-[62px]" />
                    </div>

                    <p
                        class="max-w-md mx-auto mt-6 leading-relaxed text-center text-gray-400 tablet:max-w-xs tablet:mx-0 tablet:text-left"
                    >
                    ...
                    <ul
                        class="flex justify-center gap-6 mt-8 tablet:gap-8 tablet:justify-start"
                    >
                        <li>
                            <a
                                href="/"
                ...
                <div
                    class="grid grid-cols-1 gap-8 tablet:grid-cols-2 laptop:col-span-2 desktop:grid-cols-4"
                >
                    ...
                    <div class="text-center tablet:text-left">
                        ...
                        <nav class="mt-8">
                            <ul class="space-y-4 text-sm">
                                ...
                                <li>
                                    <a
                                        class="flex group justify-center tablet:justify-start gap-1.5"
                                        href="/"
                                    >
                                        <span
                    ...
                    <div class="text-center tablet:text-left">
                        ...
                        <ul class="mt-8 space-y-4 text-sm">
                            ...
                            <li>
                                ...
                                >
                                    ...
                                    <span
                                        class="text-white transition group-hover:text-white/75"
                                    >
                                        <a :href="`tel:${contact.telephone.tel}`">{{
                            ...
                            <li
                                class="flex items-start justify-center gap-1.5 tablet:justify-start"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="w-5 h-5 text-white shrink-0"
            ...
            <div class="pt-6 mt-12 border-t border-gray-800">
                <div
                    class="text-center tablet:flex tablet:justify-between tablet:text-left"
                >
