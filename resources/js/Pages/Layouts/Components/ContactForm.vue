    ...
    <div
        ...
        <div class="text-center mb-12 tablet:mb-16">
            ...
            <div
                ...
                <p class="text-left text-base tablet:text-lg text-primary-default leading-relaxed">
                    ...
                    <span class="inline-flex items-center gap-2 mt-2">
                        ...
                        <span class="font-bold text-accent-gold">
                            <a class="email-field text-accent-terracotta hover:text-primary-dark font-medium underline decoration-accent-gold/30 hover:decoration-accent-gold transition-colors duration-300"
                    ...
                    <span class="inline-flex items-center gap-2 mt-4 text-primary-dark">
                        ...
                        Of&nbsp;gebruik&nbsp;het
                        <a href="#contact-form"
                            class="text-accent-terracotta hover:text-primary-dark font-medium underline decoration-accent-gold/30 hover:decoration-accent-gold transition-colors duration-300">contactformulier</a>
                ...
                <div
                    ...
                    <div class="grid tablet:grid-cols-2 gap-8 tablet:gap-12">
                        ...
                        <div class="space-y-6">
                            ...
                            <Text name="text" label="Bericht" :required="false" :show-label="false" v-model="form.text"
